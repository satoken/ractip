...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->fold_th_help = gengetopt_args_info_help[3] ;
  args_info->hybridize_th_help = gengetopt_args_info_help[4] ;
  args_info->acc_th_help = gengetopt_args_info_help[5] ;
  args_info->max_w_help = gengetopt_args_info_help[6] ;
  args_info->min_w_help = gengetopt_args_info_help[7] ;
  args_info->mccaskill_help = gengetopt_args_info_help[8] ;
  args_info->allow_isolated_help = gengetopt_args_info_help[9] ;
  args_info->show_energy_help = gengetopt_args_info_help[10] ;
  args_info->param_file_help = gengetopt_args_info_help[11] ;
  args_info->no_pk_help = gengetopt_args_info_help[12] ;
  args_info->rip_help = gengetopt_args_info_help[13] ;
