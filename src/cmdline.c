...
const char *gengetopt_args_info_full_help[] = {
  ...
  "  -a, --alpha=FLOAT          weight for hybridation probabilities  \n                               (default=`0.5')",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->fold_th_help = gengetopt_args_info_full_help[4] ;
  args_info->hybridize_th_help = gengetopt_args_info_full_help[5] ;
  args_info->acc_th_help = gengetopt_args_info_full_help[6] ;
  args_info->max_w_help = gengetopt_args_info_full_help[7] ;
  args_info->min_w_help = gengetopt_args_info_full_help[8] ;
  args_info->mccaskill_help = gengetopt_args_info_full_help[9] ;
  args_info->allow_isolated_help = gengetopt_args_info_full_help[10] ;
  args_info->show_energy_help = gengetopt_args_info_full_help[11] ;
  args_info->param_file_help = gengetopt_args_info_full_help[12] ;
  args_info->no_pk_help = gengetopt_args_info_full_help[13] ;
  args_info->rip_help = gengetopt_args_info_full_help[14] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVa:t:u:s:mieP:pr:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* weight for hybridation probabilities.  */
