...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->mccaskill_help = gengetopt_args_info_help[5] ;
  args_info->allow_isolated_help = gengetopt_args_info_help[6] ;
  args_info->show_energy_help = gengetopt_args_info_help[7] ;
  args_info->param_file_help = gengetopt_args_info_help[8] ;
  args_info->no_pk_help = gengetopt_args_info_help[9] ;
  args_info->rip_help = gengetopt_args_info_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVa:t:u:mieP:pr:", long_options, &option_index);
