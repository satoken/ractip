...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_w_help = gengetopt_args_info_full_help[8] ;
  args_info->min_w_help = gengetopt_args_info_full_help[9] ;
  args_info->mccaskill_help = gengetopt_args_info_full_help[10] ;
  args_info->allow_isolated_help = gengetopt_args_info_full_help[11] ;
  args_info->show_energy_help = gengetopt_args_info_full_help[12] ;
  args_info->param_file_help = gengetopt_args_info_full_help[13] ;
  args_info->no_pk_help = gengetopt_args_info_full_help[14] ;
  args_info->rip_help = gengetopt_args_info_full_help[15] ;
  args_info->pf_duplex_help = gengetopt_args_info_full_help[16] ;
  args_info->allow_concat_help = gengetopt_args_info_full_help[17] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVa:b:t:u:s:mieP:pr:", long_options, &option_index);
