...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->zscore_help = gengetopt_args_info_full_help[10] ;
  args_info->num_shuffling_help = gengetopt_args_info_full_help[11] ;
  args_info->seed_help = gengetopt_args_info_full_help[12] ;
  args_info->mccaskill_help = gengetopt_args_info_full_help[13] ;
  args_info->allow_isolated_help = gengetopt_args_info_full_help[14] ;
  args_info->show_energy_help = gengetopt_args_info_full_help[15] ;
