...
If the optimization solver has been installed to the directory other than ``/usr`` or ``/usr/local``, specify the option ``-DCPLEX_ROOT_DIR=/path/to/CPLEX`` for an example of CPLEX.
